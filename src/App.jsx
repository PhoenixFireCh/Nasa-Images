...
function App() {
  ...
  const categories = [
    {name: "Artemis", type: 0}, {name: "ISS", type: 0}, {name: "Apollo", type: 0}, {name: "Gemini", type: 0}, {name: "Skylab", type: 0},
    {name: "Hubble", type: 1}, {name: "JWST", type: 1}, {name: "Chandra", type: 1}, {name: "Double Asteroid Redirection Test", type: 1}, {name: "New Horizons", type: 1}, 
  ...
  const prepQuery = () => {
    ...
    queryItems.push(choosenCategory.name);
    ...
    for (let i = 0; i < allowedModifiers.length; i++) {
      ...
      queryItems.push(allowedModifiers[randModifiers]);
    }
